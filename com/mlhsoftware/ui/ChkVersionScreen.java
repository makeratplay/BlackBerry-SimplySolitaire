...
public class ChkVersionScreen extends MainScreen implements WebApiBase.WebAPICallback 
{
  ...
  public ChkVersionScreen( String version, String url, DlgCallback uiCallBack ) 
  {
    ...
    TitlebarManager titlebarMgr = new TitlebarManager( AppInfo.APP_NAME + " Update", "Back", null );
  ...
  private void addGetUpdateCtrl()
  {
    ...
    ListStyleRichTextlField info = new ListStyleRichTextlField( "A new version of " + AppInfo.APP_NAME + " (" + _newVersion + ") is available. Press Upgrade to download new version." );
    fieldSet.add( info );
  ...
  public void checkForUpdate()
  {
    ...
    versionCheck.setAppName( AppInfo.APP_NAME );
    versionCheck.setVersion( AppInfo.APP_VERSION );
    versionCheck.setBeta( AppInfo.BETA );
