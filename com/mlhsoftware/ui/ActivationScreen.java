...
public class ActivationScreen extends MainScreen implements WebApiBase.WebAPICallback
{
  ...
  public ActivationScreen( KeyDlgListener dlgListener )
  {
    ...
    TitlebarManager titlebarMgr = new TitlebarManager( "Activate " + AppInfo.APP_NAME, false );
    add( titlebarMgr );
    ...
    ListStyleButtonField activate = new ListStyleButtonField( null, "Activate", null );
    activate.setChangeListener( new FieldChangeListener()
    {
  ...
  {
    String helpText;
    helpText = "To unlock the full version of " + AppInfo.APP_NAME + ", you need to purchase and enter your activation key.\n" +
  ...
  private void onFetchKey()
  {
    ...
    fetchKey.setAppName( AppInfo.APP_NAME );
