...
public class LabeledSwitch extends Field
{
  ...
  private int _textColour = ListStyleField.COLOR_RIGHT_LABEL_FONT;
  ...
  public LabeledSwitch( Bitmap imageOn, Bitmap imageOff, Bitmap imageOnFocus, Bitmap imageOffFocus, String textOn, String textOff, boolean onByDefault )
  {
  ...
  {
    _labelFont = getFont().derive( Font.PLAIN, _imageOn.getHeight() - 4 );
  }
